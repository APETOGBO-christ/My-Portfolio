...
const Header = () => (
  <div className="app__header app__flex">
    ...
    >
      <div className="app__header-badge">
        ...
        <div className="tag-cmp app__flex">
          <p className="p-text">Leader & Entrepreneur</p>
          <p className="p-text">Cybersecurity Expert</p>
        </div>
    ...
    >
      {[images.leadership, images.cybersecurity, images.flutter, images.react].map((circle, index) => (
